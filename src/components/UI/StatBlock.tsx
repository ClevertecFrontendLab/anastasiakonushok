...
export const StatBlock = ({ likes, saves, views }: StatBlockProps) => (
    <Flex align='center' className={styles.stats}>
        {likes !== undefined && (
            <Flex alignItems='center' gap='6px' className={styles.stats__block}>
                <svg
                    width='12'
                    height='12'
                    viewBox='0 0 12 12'
                ...
                <Text className={styles.text}> {likes}</Text>
            </Flex>
        )}
        {saves !== undefined && (
            <Flex alignItems='center' gap='6px' className={styles.stats__block}>
                ...
                >
                    ...
                    <path
                        fill-rule='evenodd'
                        clip-rule='evenodd'
                        d='M3.912 10.5001C3.80082 10.2659 3.74537 10.0092 3.75 9.75008C3.75 8.73383 4.26 7.68758 5.202 6.96008C4.73182 6.8152 4.24196 6.74436 3.75 6.75008C0.75 6.75008 0 9.00008 0 9.75008C0 10.5001 0.75 10.5001 0.75 10.5001H3.912Z'
                        fill='black'
                    />
                    <path
                ...
                <Text className={styles.text}>{saves}</Text>
            </Flex>
        )}
        {views !== undefined && (
            <Flex alignItems='center' gap='6px' className={styles.stats__block}>
                ...
                <Text className={styles.text}>{views}</Text>
            </Flex>
        )}
    </Flex>
);
