...
import { Flex, IconButton, Input, InputGroup, Select, Switch, Text } from '@chakra-ui/react';

export const FilterPanel = () => (
    <Flex width={{ base: '100%', md: '60%' }} maxW='550px' m='auto' gap='16px' direction='column'>
        <Flex gap='12px' align='center' justify='center'>
            ...
            <InputGroup maxW='600px' flex='1' position='relative'>
                <Input
                    placeholder='Название или ингредиент...'
                    _placeholder={{ color: 'green.800' }}
                    pr='2.5rem'
                />
                <Flex
                    position='absolute'
        ...
        <Flex gap='16px' align='center' justify='center' display={{ base: 'none', md: 'flex' }}>
            <Flex gap='12px' align='center' display={{ base: 'none', sm: 'flex' }}>
            ...
            <Select placeholder='Выберите из списка...' maxW='250px' />
        </Flex>
    </Flex>
);
